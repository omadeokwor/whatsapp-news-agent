"""
Daily WhatsApp news + portfolio brief — powered by Google Gemini.

Usage:
  python agent_genai.py          # runs once now, then daily at 8 AM
  python agent_genai.py --once   # run once and exit
"""
import argparse
import logging
...
def run() -> None:
    ...
    from summarizer_genai import build_message
